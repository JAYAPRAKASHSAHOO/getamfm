...
/// <reference name="System.BitConverter.js" assembly="System" />
...
System._bitConverter = function(){
	...
	this.GetBytes = function(value, typeCode){
		...
		switch (typeof(value)){
			...
			case "number":
				switch (typeCode){
					case System.TypeCode.Single:  return this.GetBytesFromNumber(value, 32);  break;
					case System.TypeCode.Double:  return this.GetBytesFromNumber(value, 64);  break;
					case System.TypeCode.Int16:
					case System.TypeCode.UInt16:  return this.GetBytesFromInt16Le(value); break;
					case System.TypeCode.Int32:
					case System.TypeCode.UInt32:  return this.GetBytesFromInt32Le(value); break;
					default:                      return this.GetBytesFromInt32Le(value); break;
				}
				break;
			case "object":
				...
				switch (typeCode){
					...
					case System.TypeCode.Int32:
					case System.TypeCode.UInt32: return this.GetBytesFromInt32ArrayLe(value); break;
					default:                     return this.GetBytesFromInt32ArrayLe(value); break;
				}
				break;
			default:
				// Unknown type.
	...
	this.ToInt16Le = function(value, startIndex){
		...
		/// <param name="value">An array of bytes.</param>
		/// <param name="startIndex">The starting position within value.</param>
		return this.ToInt16ArrayLe(value, startIndex, 2)[0];
	}
	//---------------------------------------------------------
	this.ToInt16Be = function(value, startIndex){
		...
		/// <param name="value">An array of bytes.</param>
		/// <param name="startIndex">The starting position within value.</param>
		return this.ToInt16ArrayBe(value, startIndex, 2)[0];
	}
	//---------------------------------------------------------	
	...
	this.ToNumber = function(value){
		...
		var value = sign + array.join("").replace(/(\d)0+$/, "$1");
		return +eval(value);
	}
	//---------------------------------------------------------
	function Add(A, P){
